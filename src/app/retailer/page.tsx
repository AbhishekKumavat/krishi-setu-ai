                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-bold bg-gradient-to-r from-green-700 to-emerald-500 bg-clip-text text-transparent">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                <div className="mb-8">
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-white border-2 border-gray-200 rounded-2xl py-4 pl-14 pr-6 text-lg focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/20 transition-all shadow-sm"
                            value={searchQuery}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredRetailers.map((retailer) => (
                        ...
                        >
                            <div className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                ...
                                <div className="p-6">
                                    <div className="flex items-start gap-4 mb-4 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                                        <div className="p-2 bg-white rounded-lg shadow-sm">
                                            <MapPin className="w-5 h-5 text-red-500" />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-gray-900 text-sm">Location</h3>
                                            <p className="text-gray-600 mt-1 text-sm">{retailer.location}</p>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-4 mb-6 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                                        <div className="p-2 bg-white rounded-lg shadow-sm">
                                            <Phone className="w-5 h-5 text-blue-500" />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-gray-900 text-sm">Contact</h3>
                                            <p className="text-gray-600 mt-1 text-sm">{retailer.contact}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button className="bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-full font-bold shadow-md shadow-green-200 transition-all flex items-center gap-2 group-hover:gap-3">
                ...
                {filteredRetailers.length === 0 && !loading && (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">No retailers found</h3>
