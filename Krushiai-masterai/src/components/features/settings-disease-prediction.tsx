...
// Crops supported by the Python API backend
...
const diseaseFormSchema = z.object({
    crop_name: z.string().min(1, 'Please select a crop.'),
        ...
        <div className="grid gap-8 lg:grid-cols-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Select a crop and upload a clear photo of the affected area.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...diseaseForm}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="e.g., tomato, wheat, chilli, banana..." {...field} />
                                        </FormControl>
                                        <p className="text-xs text-muted-foreground mt-1">
                                            API supports: Chilli, Cotton, Groundnut, Maize, Rice, Sugarcane, Tomato, Wheat, Potato, Onion, Soybean
                                        </p>
                                        <FormMessage />
                                    </FormItem>
                                )}
